				...
				<Layout>
					<Container fluid>
						<div className="not-found">
							<Head>
								<title>
									Page introuvable - POP - Plateforme Ouverte
									du Patrimoine
								</title>
							</Head>
							<div className="not-found-left">
								<h1>POPSI !</h1>
								<p>
									La page que vous recherchez est
									introuvable...
									<br />
									<br />
									Ne désespérez pas, nos archéobogues sont sur
									le coup !<br />
									Vous pouvez{" "}
									<a href="/">
						...
						<Row>
							<Col>
								...
								<p>
									...
									<br />
									L'équipe est dessus, revenez dans quelques
									instants.
								</p>
							</Col>
							<Col>
								<img
									src="/static/roy-lichtenstein.jpg"
									alt="I...I'm sorry, Roy Lichtenstein"
								/>
								<br />

...
export default class extends React.Component {
	componentDidMount() {
		...
		EAnalytics.track(["path", "Accueil", "pagegroup", "accueil"]);
		...
		return (
			<Layout>
				<div className="home">
					<Head>
						<title>
							POP - Plateforme Ouverte du Patrimoine - Ministère
							de la Culture
						</title>
						<meta
							name="description"
					...
					<div className="home-search-background">
						<div className="home-search">
							<h1>
								La plateforme POP regroupe les contenus
								numériques du patrimoine français afin de les
								rendre accessibles et consultables au plus grand
								nombre
							</h1>
							<Input
								id="main-search"
						...
						<p className="legend">
							Raymond Voinquel : Anthony Quinn (Quasimodo) et Gina
							Lollobrigida (Esmeralda) dans Notre-Dame de Paris de
							Jean Delannoy (1956).
						</p>
					</div>

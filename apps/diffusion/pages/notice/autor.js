...
export default class extends React.Component {
	...
	async componentDidMount() {
		...
		EAnalytics.track([
			"path",
			`Notice Autor ${this.props.notice?.REF}`,
			"pagegroup",
			"Ressources biographiques (Autor)",
		]);
	...
	render() {
		...
		const { title, images, datesLieus, referenceArk } =
						...
						<Row>
							<Col md="8">
								<div className="notice-details">
									...
									/>
									<Field
										title={mapping.autor.NOM.label}
										content={notice.NOM}
										separator="#"
									/>
									<Field
										title={mapping.autor.PREN.label}
										content={notice.PREN}
										separator="#"
									/>
									<Field
										title={mapping.autor.PNOM.label}
										content={notice.PNOM}
										separator="#"
									/>
									<Field
										title={mapping.autor.TYPID.label}
										content={notice.TYPID}
										separator="#"
									/>
									<Field
										title={mapping.autor.ALIAS.label}
										content={notice.ALIAS}
										separator="#"
									/>
									<Field
										title={mapping.autor.INI.label}
										content={notice.INI}
										separator="#"
									/>
									<Field
										title={mapping.autor.REJET.label}
										content={notice.REJET}
										separator="#"
									/>
									<Field
										title={mapping.autor.NATIO.label}
										content={notice.NATIO}
										separator="#"
									/>
									<Field
										title="Dates (lieus) d’existence"
										content={datesLieus}
										separator="#"
									/>
									<Field
										title={mapping.autor.ADRS.label}
										content={notice.ADRS}
										separator="#"
									/>
									...
									/>
									<Field
										title={mapping.autor.FONC.label}
										content={notice.FONC}
										separator="#"
									/>
									<Field
										title={mapping.autor.LOCACT.label}
										content={notice.LOCACT}
										separator="#"
									/>
									<Field
										title={mapping.autor.DATES.label}
										content={notice.DATES}
										separator="#"
									/>
									<Field
										title={mapping.autor.LRELA.label}
										content={notice.LRELA}
										separator="#"
									/>
									<Field
										title={mapping.autor.FORM.label}
										content={notice.FORM}
										separator="#"
									/>
									<Field
										title={mapping.autor.OEUVR.label}
										content={notice.OEUVR}
										separator="#"
										addLink={true}
									/>
									<Field
										title={mapping.autor.SYMB.label}
										content={notice.SYMB}
										separator="#"
									/>
									<Field
										title={mapping.autor.INS.label}
										content={notice.INS}
										separator="#"
									/>
									<Field
										title={mapping.autor.GAR.label}
										content={notice.GAR}
										separator="#"
									/>
									<Field
										title={mapping.autor.PREF.label}
										content={notice.PREF}
										separator="#"
									/>
									<Field
										title={mapping.autor.BIF.label}
										content={notice.BIF}
										separator="#"
									/>
									...
									/>
									<Field
										title={mapping.autor.BIO.label}
										content={notice.BIO}
										separator="#"
									/>
									<Field
										title={mapping.autor.OBS.label}
										content={notice.OBS}
										separator="#"
									/>
									...
									/>
									<Field
										title={mapping.autor.SOURCES.label}
										content={notice.SOURCES}
										separator="#"
										addLink={true}
									/>
									<Field
										title={mapping.autor.BIBLIO.label}
										content={notice.BIBLIO}
										separator="#"
										addLink={true}
									/>
									<Field
										title={mapping.autor.PUBLI.label}
										content={notice.PUBLI}
										separator="#"
										addLink={true}
									/>
									<Field
										title={mapping.autor.EXPO.label}
										content={notice.EXPO}
										separator="#"
										addLink={true}
									/>
									<Field
										title={
											mapping.autor.ISNI_VERIFIEE.label
										}
										content={referenceArk}
										separator="#"
									/>
								</div>
							</Col>
							<Col md="4">
								...
								<div className="sidebar-section info">
									...
									<div>
										<Field
											title={mapping.autor.REF.label}
											content={notice.REF}
										/>
										<Field
											title={mapping.autor.BASE.label}
											content={notice.BASE}
										/>
									</div>
									<ContactUs

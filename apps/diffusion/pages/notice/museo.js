...
export default class extends React.Component {
	...
	async componentDidMount() {
		...
		EAnalytics.track([
			"path",
			`Notice Museo ${this.props.notice?.REF}`,
			"pagegroup",
		...
		const App = () => (
			<div>
				<PDFDownloadLink
					...
					onClick={() => trackDownload(`museo_${notice.REF}.pdf`)}
				>
						...
						<Row>
							<Col className="image" md="8">
								<div className="notice-details">
									...
									/>
									<Field
										title={mapping.museo.NOMOFF.label}
										content={notice.NOMOFF}
										upper={false}
									/>
									<Field
										title={mapping.museo.NOMUSAGE.label}
										content={notice.NOMUSAGE}
									/>
									<Field
										title={mapping.museo.AUTNOM.label}
										content={notice.AUTNOM}
									/>
									<Title
										content="Adresse"
										notice={notice}
									...
									/>
									<Field
										title={mapping.museo.ADRL1_M.label}
										content={notice.ADRL1_M}
									/>
									<Field
										title={mapping.museo.LIEU_M.label}
										content={notice.LIEU_M}
									/>
									<Field
										title={mapping.museo.CP_M.label}
										content={notice.CP_M}
									/>
									<Field
										title={mapping.museo.VILLE_M.label}
										content={notice.VILLE_M}
									/>
									<Field
										title={mapping.museo.DPT.label}
										content={notice.DPT}
									/>
									<Field
										title={mapping.museo.REGION.label}
										content={notice.REGION}
									/>
									...
									/>
									<Field
										title={mapping.museo.TEL_M.label}
										content={notice.TEL_M}
									/>
									<Field
										title={
											mapping.museo.CONTACT_GENERIQUE
												.label
										}
										content={notice.CONTACT_GENERIQUE}
										upper={false}
									/>
									<Field
									...
									/>
									<Field
										title={mapping.museo.ACCES.label}
										content={notice.ACCES}
									/>
									<Title
									...
									/>
									<Field
										title={mapping.museo.LABEL.label}
									...
									/>
									<Field
										title={mapping.museo.CATEG.label}
										content={notice.CATEG}
									/>
									<Field
										title={mapping.museo.DOMPAL.label}
										content={notice.DOMPAL}
									/>
									<Field
										title={mapping.museo.HIST.label}
										content={notice.HIST}
									/>
									<Field
										title={mapping.museo.ATOUT.label}
										content={notice.ATOUT}
									/>
									<Field
										title={mapping.museo.THEMES.label}
										content={notice.THEMES}
									/>
									<Field
										title={mapping.museo.ARTISTE.label}
										content={notice.ARTISTE}
									/>
									<Field
										title={mapping.museo.PHARE.label}
										content={notice.PHARE}
									/>
									<Field
										title={mapping.museo.AN_CREAT.label}
										content={notice.AN_CREAT}
									/>
									<Field
										title={mapping.museo.INTERET.label}
										content={notice.INTERET}
									/>
									<Field
										title={mapping.museo["PROT-BAT"].label}
										content={notice["PROT-BAT"]}
									/>
									<Field
										title={mapping.museo["PROT-ESP"].label}
										content={notice["PROT-ESP"]}
									/>
								</div>
							</Col>
							<Col md="4">
								...
								<div className="sidebar-section info">
									...
									<div>
										<Field
											title={mapping.museo.REF.label}
											content={notice.REF}
										/>
										<Field
											title={mapping.museo.BASE.label}
											content={notice.BASE}
										/>
										<Field
											title={mapping.museo.COPY.label}
											content={notice.COPY}
										/>
										<Field
											title={mapping.museo.DT_SAISI.label}
											content={notice.DT_SAISI}
										/>
									</div>
									<ContactUs
										contact={notice.CONTACT_GENERIQUE}
										REF={notice.REF}
										base="museo"
									/>
								</div>
								<div
									className="onPrintHide"
									style={{
										display: "flex",

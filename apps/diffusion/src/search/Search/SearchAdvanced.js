      ...
      switch (this.props.base) {
        ...
        case "joconde":
          fields = [
            ...
            { value:["DATA.keyword"], text:"Artiste sous droits", fields: "DATA"},
            ...
            { value:["LOCA.keyword"], text:"Localisation", fields: "LOCA"},
            { value:["LOCA3.keyword"], text:"Date d'entrée dans le domaine public", fields: "LOCA3"},
        ...
        case "palissy":
          fields = [
            ...
            {value: ["APPL.keyword"], text: "Appellation d'usage", fields: "APPL"},
        ...
        case "enluminures":
          fields = [
            ...
            {value: ["ATTRIB.keyword"], text: "Artiste", fields: "ATTRIB"},
            {value: ["AUTR.keyword"], text: "Auteur de l'oeuvre", fields: "AUTR"},
            {value: ["AUTS.keyword"], text: "Éditeur de l'oeuvre", fields: "AUTS"},
            {value: ["BASE.keyword"], text: "Nom de la base", fields: "BASE"},
            ...
            {value: ["DIMS.keyword"], text: "Dimensions du codex", fields: "DIMS"},
            {value: ["DMAJ.keyword"], text: "Date de mise à jour", fields: "DMAJ"},
            {value: ["DMIS.keyword"], text: "Date de création", fields: "DMIS"},
            ...
            {value: ["ETAB.keyword"], text: "Établissement de conservation", fields: "ETAB"},
            ...
            {value: ["LIENS.keyword"], text: "Liens externes éventuels", fields: "LIENS"},
            {value: ["LOCA.keyword"], text: "Ville", fields: "LOCA"},
            ...
            {value: ["RENV.keyword"], text: "Numéro de renvoi vers un autre domaine", fields: "RENV"},
            {value: ["REFC.keyword"], text: "Numéro de renvoi vers une référence du contenu matériel", fields: "REFC"},
            {value: ["REFDE.keyword"], text: "Numéro de renvoi vers une référence du décor", fields: "REFDE"},
            ...
            {value: ["TOUT.keyword"], text: "TOUT", fields: "TOUT"},
            {value: ["TYPCOD.keyword"], text: "Type codicologique", fields: "TYPCOD"},

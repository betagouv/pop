      ...
      switch (this.props.base) {
        ...
        case "palissy":
          fields = [
            ...
            {value: ["POP_ARRETE_PROTECTION.keyword"], text: "Arrêté de protection MH", fields: "POP_ARRETE_PROTECTION"},
            {value: ["POP_CONTIENT_GEOLOCALISATION.keyword"], text: "POP_CONTIENT_GEOLOCALISATION", fields: "POP_CONTIENT_GEOLOCALISATION"},
            {value: ["POP_COORDINATES_POLYGON.coordinates.keyword"], text: "POP_COORDINATES_POLYGON.coordinates", fields: "POP_COORDINATES_POLYGON.coordinates"},
            {value: ["POP_COORDINATES_POLYGON.type.keyword"], text: "POP_COORDINATES_POLYGON.type", fields: "POP_COORDINATES_POLYGON.type"},
            {value: ["POP_COORDONNEES.lat.keyword"], text: "Latitude", fields: "POP_COORDONNEES.lat"},
            {value: ["POP_COORDONNEES.lon.keyword"], text: "Longitude", fields: "POP_COORDONNEES.lon"},
            {value: ["POP_DOSSIER_PROTECTION.keyword"], text: "Dossier de protection MH", fields: "POP_DOSSIER_PROTECTION"},
            {value: ["POP_DOSSIER_VERT.keyword"], text: "PDF Inventaire(dossier verts)", fields: "POP_DOSSIER_VERT"},
            {value: ["POP_FLAGS.keyword"], text: "Alertes POP", fields: "POP_FLAGS"},
            {value: ["POP_IMPORT.keyword"], text: "Import", fields: "POP_IMPORT"},
            {value: ["ACQU.keyword"], text: "Contexte d'acquisition", fields: "ACQU"},
            {value: ["ADRS.keyword"], text: "Adresse de l'édifice", fields: "ADRS"},
            {value: ["ADRS2.keyword"], text: "Adresse de l'édifice contenant masqué", fields: "ADRS2"},
            ...
            {value: ["COM.keyword"], text: "Commune", fields: "COM"},
            {value: ["COM2.keyword"], text: "Commune masquée", fields: "COM2"},
            ...
            {value: ["EDIF2.keyword"], text: "Edifice contenant masqué", fields: "EDIF2"},
            {value: ["EMPL.keyword"], text: "Emplacement de l’œuvre dans l’édifice", fields: "EMPL"},
            {value: ["EMPL2.keyword"], text: "Emplacement dans l'édifice masqué", fields: "EMPL2"},
            ...
            {value: ["INSEE2.keyword"], text: "Code INSEE masqué", fields: "INSEE2"},
            {value: ["INTE.keyword"], text: "Intérêt de l'objet", fields: "INTE"},
            {value: ["JDAT.keyword"], text: "Justification de la datation", fields: "JDAT"},
            {value: ["LBASE2.keyword"], text: "Référence de la notice cible Palissy pour Mémoire", fields: "LBASE2"},
        ...
        case "merimee":
          fields = [
            ...
            {value: ["POP_ARRETE_PROTECTION.keyword"], text: "Arrêté de protection MH", field: "POP_ARRETE_PROTECTION"},
            {value: ["POP_CONTIENT_GEOLOCALISATION.keyword"], text: "Contient une géolocalisation", field: "POP_CONTIENT_GEOLOCALISATION"},
            {value: ["POP_COORDINATES_POLYGON.coordinates.keyword"], text: "POP_COORDINATES_POLYGON.coordinates", field: "POP_COORDINATES_POLYGON.coordinates"},
            {value: ["POP_COORDINATES_POLYGON.type.keyword"], text: "POP_COORDINATES_POLYGON.type", field: "POP_COORDINATES_POLYGON.type"},
            {value: ["POP_COORDONNEES.lat.keyword"], text: "Latitude", field: "POP_COORDONNEES.lat"},
            {value: ["POP_COORDONNEES.lon.keyword"], text: "Longitude", field: "POP_COORDONNEES.lon"},
            {value: ["POP_DATE.keyword"], text: "POP_DATE", field: "POP_DATE"},
            {value: ["POP_DOSSIER_PROTECTION.keyword"], text: "Dossier de protection MH", field: "POP_DOSSIER_PROTECTION"},
            {value: ["POP_DOSSIER_VERT.keyword"], text: "PDF Inventaire (dossier verts)", field: "POP_DOSSIER_VERT"},
            {value: ["POP_FLAGS.keyword"], text: "Alertes POP", field: "POP_FLAGS"},
            {value: ["POP_IMPORT.keyword"], text: "Import", field: "POP_IMPORT"},
            {value: ["ACTU.keyword"], text: "Destination actuelle de l'édifice", field: "ACTU"},
            {value: ["ADRS.keyword"], text: "Adresse de l'édifice", field: "ADRS"},
            {value: ["AFFE.keyword"], text: "Affectataire de l'édifice", field: "AFFE"},
            {value: ["AIRE.keyword"], text: "Aire d'étude pour le domaine Inventaire", field: "AIRE"},
            {value: ["APPL.keyword"], text: "Appelation d'usage", field: "APPL"},
            {value: ["APRO.keyword"], text: "Nature de l'acte de protection", field: "APRO"},
            {value: ["AUTP.keyword"], text: "Auteur de la photographie (Mémoire)", field: "AUTP"},
            {value: ["AUTR.keyword"], text: "Auteur de l'édifice", field: "AUTR"},
            {value: ["BASE.keyword"], text: "Nom de la base", field: "BASE"},
            {value: ["CADA.keyword"], text: "Références cadastrales", field: "CADA"},
            {value: ["CANT.keyword"], text: "Canton", field: "CANT"},
            {value: ["COLL.keyword"], text: "Nombre d'édifices concernés par l'étude", field: "COLL"},
            {value: ["COM.keyword"], text: "Commune normalisée", field: "COM"},
            {value: ["CONTACT.keyword"], text: "Adresse courriel de contact", field: "CONTACT"},
            {value: ["CONTIENT_IMAGE.keyword"], text: "Contient une image", field: "CONTIENT_IMAGE"},
            {value: ["COOR.keyword"], text: "Coordonnées géographiques d'un point", field: "COOR"},
            {value: ["COORM.keyword"], text: "Coordonnées géographiques multiples", field: "COORM"},
            {value: ["COPY.keyword"], text: "Copyright de la notice", field: "COPY"},
            {value: ["COUV.keyword"], text: "Typologie de couverture", field: "COUV"},
            {value: ["DATE.keyword"], text: "Année(s) de(s) campagne(s) de construction", field: "DATE"},
            {value: ["DBOR.keyword"], text: "Date de rédaction de la notice", field: "DBOR"},
            {value: ["DENO.keyword"], text: "Dénomination de l'édifice", field: "DENO"},
            {value: ["DENQ.keyword"], text: "Date de l'enquête ou du dernier récolement", field: "DENQ"},
            {value: ["DEPL.keyword"], text: "Lieu de conservation d'un élément architectural déplacé", field: "DEPL"},
            {value: ["DESC.keyword"], text: "Commentaire descriptif de l'édifice", field: "DESC"},
            {value: ["DIMS.keyword"], text: "Dimensions normalisées des édicules uniquement", field: "DIMS"},
            {value: ["DLAB.keyword"], text: "Date de label", field: "DLAB"},
            {value: ["DMAJ.keyword"], text: "Date de la dernière modification de la notice", field: "DMAJ"},
            {value: ["DMIS.keyword"], text: "Date de versement de la notice", field: "DMIS"},
            {value: ["DOSADRS.keyword"], text: "Adresse du dossier Inventaire", field: "DOSADRS"},
            {value: ["DOSS.keyword"], text: "Typologie du dossier", field: "DOSS"},
            {value: ["DOSURL.keyword"], text: "URL du dossier Inventaire", field: "DOSURL"},
            {value: ["DOSURLPDF.keyword"], text: "Lien vers le dossier PDF", field: "DOSURLPDF"},
            {value: ["DPRO.keyword"], text: "Date et niveau de protection de l'édifice", field: "DPRO"},
            {value: ["DPT.keyword"], text: "Département", field: "DPT"},
            {value: ["DPT_LETTRE.keyword"], text: "Département en lettre", field: "DPT_LETTRE"},
            {value: ["EDIF.keyword"], text: "Nom de l'édifice", field: "EDIF"},
            {value: ["ELEV.keyword"], text: "Partie d'élévation extérieure", field: "ELEV"},
            {value: ["ENER.keyword"], text: "Source de l'énergie utilisée par l'édifice", field: "ENER"},
            {value: ["ESCA.keyword"], text: "Emplacement, forme et structure de l'escalier", field: "ESCA"},
            {value: ["ETAG.keyword"], text: "Description de l'élévation intérieure", field: "ETAG"},
            {value: ["ETAT.keyword"], text: "État de conservation (normalisé)", field: "ETAT"},
            {value: ["ETUD.keyword"], text: "Cadre de l'étude", field: "ETUD"},
            {value: ["GENR.keyword"], text: "Genre du destinataire", field: "GENR"},
            {value: ["HIST.keyword"], text: "Description historique", field: "HIST"},
            {value: ["HYDR.keyword"], text: "Nom du cours d'eau traversant ou bordant l'édifice", field: "HYDR"},
            {value: ["IDAGR.keyword"], text: "Référence informatique SIMH", field: "IDAGR"},
            {value: ["IMPL.keyword"], text: "Milieu d'implantation pour le domaine Inventaire", field: "IMPL"},
            {value: ["INSEE.keyword"], text: "Numéro INSEE de la commune", field: "INSEE"},
            {value: ["INTE.keyword"], text: "Intérêt de l'édifice", field: "INTE"},
            {value: ["JATT.keyword"], text: "Commentaires concernant l'attribution de l'édifice", field: "JATT"},
            {value: ["JDAT.keyword"], text: "Commentaires concernant la datation", field: "JDAT"},
            {value: ["LIENS.keyword"], text: "Liens externes éventuels", field: "LIENS"},
            {value: ["LIEU.keyword"], text: "Lieu-dit", field: "LIEU"},
            {value: ["LOCA.keyword"], text: "Localisation complète", field: "LOCA"},
            {value: ["MEMOIRE.keyword"], text: "Mémoire", field: "MEMOIRE"},
            {value: ["MHPP.keyword"], text: "Précisions sur les éléments protégés", field: "MHPP"},
            {value: ["MURS.keyword"], text: "Matériaux du gros-œuvre", field: "MURS"},
            {value: ["NOMS.keyword"], text: "Nom du rédacteur", field: "NOMS"},
            {value: ["OBS.keyword"], text: "Observations concernant la protection de l'édifice", field: "OBS"},
            {value: ["PAFF.keyword"], text: "Précisions concernant l'affectataire de l'édifice", field: "PAFF"},
            {value: ["PARN.keyword"], text: "Partie constituante non étudiée", field: "PARN"},
            {value: ["PART.keyword"], text: "Partie constituante", field: "PART"},
            {value: ["PDEN.keyword"], text: "Précision sur la dénomination de l'édifice", field: "PDEN"},
            {value: ["PERS.keyword"], text: "Personnalités liées à l'histoire de l'édifice", field: "PERS"},
            {value: ["PINT.keyword"], text: "Intérêt oeuvre", field: "PINT"},
            {value: ["PLAN.keyword"], text: "Typologie de plan", field: "PLAN"},
            {value: ["PLOC.keyword"], text: "Précision sur la localisation", field: "PLOC"},
            {value: ["PPRO.keyword"], text: "Précision sur la protection de l'édifice", field: "PPRO"},
            {value: ["PREP.keyword"], text: "Description de l'iconographie", field: "PREP"},
            {value: ["PRODUCTEUR.keyword"], text: "PRODUCTEUR", field: "PRODUCTEUR"},
            {value: ["PROT.keyword"], text: "Nature de la protection de l'édifice", field: "PROT"},
            {value: ["PSTA.keyword"], text: "Précisions sur le statut juridique du propriétaire", field: "PSTA"},
            {value: ["REFE.keyword"], text: "Références de l'édifice de conservation", field: "REFE"},
            {value: ["REFO.keyword"], text: "Référence aux objets conservés", field: "REFO"},
            {value: ["REFP.keyword"], text: "Références des parties constituantes étudiées", field: "REFP"},
            {value: ["REG.keyword"], text: "Région", field: "REG"},
            {value: ["REMA.keyword"], text: "Eléments remarquables dans l'édifice", field: "REMA"},
            {value: ["REMP.keyword"], text: "Remploi", field: "REMP"},
            {value: ["RENV.keyword"], text: "Numéro de renvoi vers un autre domaine", field: "RENV"},
            {value: ["REPR.keyword"], text: "Indexation iconographique normalisée", field: "REPR"},
            {value: ["RFPA.keyword"], text: "Identifiant de la base TrouveTout", field: "RFPA"},
            {value: ["SCLD.keyword"], text: "Siècle de campagne secondaire de consctruction", field: "SCLD"},
            {value: ["SCLE.keyword"], text: "Siècle de la campagne principale de construction", field: "SCLE"},
            {value: ["SITE.keyword"], text: "Typologie de la zone de protection", field: "SITE"},
            {value: ["STAT.keyword"], text: "Statut juridique du propriétaire", field: "STAT"},
            {value: ["TECH.keyword"], text: "Technique du décor porté de l'édifice", field: "TECH"},
            {value: ["TICO.keyword"], text: "Titre courant", field: "TICO"},
            {value: ["TOIT.keyword"], text: "Matériaux de la couverture ", field: "TOIT"},
            {value: ["TOUT.keyword"], text: "Tout", field: "TOUT"},
            {value: ["TYPO.keyword"], text: "Commentaires d'usage régional", field: "TYPO"},
            {value: ["VERT.keyword"], text: "Couverts ou découverts du jardin de l'édifice", field: "VERT"},
            {value: ["VISI.keyword"], text: "Conditions d'ouverture au public", field: "VISI"},
            {value: ["VOCA.keyword"], text: "pour les édifices cultuels", field: "VOCA"},
            {value: ["VOUT.keyword"], text: "Typologie du couvrement", field: "VOUT"},
            {value: ["WADRS.keyword"], text: "Adresse pour l'affichage", field: "WADRS"},
            {value: ["WCOM.keyword"], text: "Commune pour l'affichage", field: "WCOM"},
            {value: ["WEB.keyword"], text: "Accès Mémoire", field: "WEB"}

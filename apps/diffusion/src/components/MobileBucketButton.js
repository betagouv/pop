    ...
    removeFromBucket(base, ref){
        ...
        if(base && ref){
            for (let i = 0; i < currentBucket.length; i++) {
                if (currentBucket[i].ref === ref && currentBucket[i].base === base) {
    ...
    render() {
        return (
            <div className="btn-container">
                <div  className="btn btn-outline-second onPrintHide" onClick={() => this.props.removeFromBucket(this.props.reference)}>
                ...
                <div className="btn btn-outline-success util-pos-relat" onClick={() => this.removeFromBucket(this.props.base, this.props.reference)}>

...
const api_url = process.env.API_URL ? process.env.API_URL : "localhost:3000";
...
const doc = {
	...
	definitions: {
		...
		GetEnluminures: {
			...
			POSS: ["anonyme femme (destinataire)", "Morel, Gabriel"],
			...
			LOCA2: "",
			VISITE: "",
			VIDEO: ["enluminures/D-000001/IRHT_079949-p.jpg"],
			TOUT: "",
			IMG: "",
			DMAJ: "2019-01-01",
			DMIS: "2019-01-01",

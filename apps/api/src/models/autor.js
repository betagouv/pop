...
const Schema = new mongoose.Schema(
  {
    ...
    FONC: { type: [String], default: [], documentation: { label: "Profession" } },
    ...
    REJET: { type: [String], default: [], documentation: { label: "Forme rejetée du nom" } },
    ...
    GAR: { type: String, default: "", documentation: { label: "Numéro du registre de la garantie (pour les orfèvres)" } },
    PREF: { type: String, default: "", documentation: { label: "Numéro du registre de la préfecture (pour les orfèvres)" } },
    BIF: { type: String, default: "", documentation: { label: "Date de biffage (pour les orfèvres)" } },

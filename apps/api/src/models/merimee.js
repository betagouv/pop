...
const Schema = new mongoose.Schema(
	{
		...
		AFFE: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T97",
		...
		APRO: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T98",
		...
		COPY: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T21",
		...
		COUV: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T26",
		...
		DEPL: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T14",
		...
		DIMS: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T11",
		...
		DOSS: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T13",
		...
		ELEV: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T25",
		...
		ENER: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T27",
		...
		ESCA: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T29",
				label: "Emplacement, forme et structure de l'escalier",
				listeAutorite:
					"Lexique de l'escalier et des autres organes de circulation : emplacement, forme et structure - Inventaire/MH",
				idthesaurus: "th380",
			},
		},
		ETAG: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T23",
		...
		ETAT: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T30",
		...
		ETUD: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T68",
		...
		GENR: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T197",
				label: "Genre du destinataire",
				listeAutorite:
					"Genre du destinataire de l'édifice - Inventaire/MH",
				idthesaurus: "th383",
			},
		},
		HIST: {
		...
		IMPL: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T12",
		...
		INTE: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T33",
		...
		MURS: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T57",
		...
		PERS: {
			...
			documentation: {
				description: "",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T6",
		...
		PROT: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T10",

...
const Schema = new mongoose.Schema(
	{
		...
		DENO: {
			...
			documentation: {
				...
				label: "Dénomination",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T505",
		...
		DEPO: {
			...
			documentation: {
				...
				label: "Lieu de dépot",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T515",
		...
		DOMN: {
			...
			documentation: {
				...
				label: "Domaine",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T51",
		...
		ECOL: {
			...
			documentation: {
				...
				label: "Ecole-pays",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T517",
		...
		EPOQ: {
			...
			documentation: {
				...
				label: "Epoque",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T93",
		...
		GENE: {
			...
			documentation: {
				...
				label: "Genèse",
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T506",
		...
		PEOC: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T521",
		...
		TECH: {
			...
			documentation: {
				...
				thesaurus:
					"http://data.culture.fr/thesaurus/resource/ark:/67717/T516",

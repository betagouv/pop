...
const Schema = new mongoose.Schema(
	{
		...
		ARTISTE: {
			...
			default: "",
			documentation: {
				label: "Artistes phares",
				description: "Artistes de la collection",
			},
		},
		ATOUT: {
			type: String,
		...
		COPY: {
			...
			default: "",
			documentation: {
				label: "Copyright photo",
				description: "Copyright de la photo du musée",
			},
		},
		CP_M: {
			type: String,
      ...
      `,
		...
		DPT: {
			...
			documentation: {
				label: "Département",
				description: "Département en toutes lettres",
			},
		},
		DT_MODIF: {
			type: String,
...
`,
		...
		REGION: {
			...
			documentation: {
				label: "Région",
				description: "Région en toutes lettres",
			},
		},
		TEL_M: {
			type: String,
			...
			documentation: {
				label: "Téléphone",
				description: "Téléphone principal du musée",
			},
		},
		CONTACT_GENERIQUE: {
			type: String,
		...
		VILLE_M: {
			...
			documentation: {
				label: "Ville",
				description: "Nom de la commune, agglomération…",
			},
		},
		...
		AN_CREAT: {
			...
			default: "",
			documentation: {
				label: "Année de création du musée",
		...
		URL_M2: {
			type: String,
			default: "",
			documentation: { label: "Site web 2" },
		},

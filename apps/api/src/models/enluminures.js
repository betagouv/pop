...
const Schema = new mongoose.Schema(
  {
    ...
    ATTRIB: {
      type: String,
      default: "",
      documentation: { label: "Auteur de l'oeuvre ou de l'original", label_inid: "Artiste", label_inicm: "" }
    },
    APPL: { type: String, default: "", documentation: { label: "" } },
    AUTR: { type: String, default: "", documentation: { label: "", label_inid: "", label_inicm: "Auteur de l'oeuvre" } },
    AUTS: { type: String, default: "", documentation: { label: "", label_inid: "", label_inicm: "Editeur de l'incunable" } },
    ...
    DIMS: { type: String, default: "", documentation: { label: "", label_inid: "Dimensions du codex", label_inicm: "Dimensions du codex" } },
    ETAB: { type: String, default: "", documentation: { label: "", label_inid: "Etablissement de conservation", label_inicm: "Etablissement de conservation" } },
    ...
    TYPCOD: { type: String, default: "", documentation: { label: "", label_inid: "", label_inicm: "Type codicologique" } },

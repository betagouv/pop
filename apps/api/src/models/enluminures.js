...
const Schema = new mongoose.Schema(
  {
    ...
    ATTRIB: {
      type: String,
      default: "",
      documentation: { label: "Artiste", label_inid: "Artiste", label_inicm: "" }
    },
    APPL: { type: String, default: "", documentation: { label: "" } },
    AUTR: { type: String, default: "", documentation: { label: "Auteur de l'oeuvre", label_inid: "", label_inicm: "Auteur de l'oeuvre" } },
    AUTS: { type: String, default: "", documentation: { label: "Éditeur de l'oeuvre", label_inid: "", label_inicm: "Editeur de l'incunable" } },
    CONSERV: { type: String, default: "", documentation: { label: "" } },
    CONTXT: { type: String, default: "", documentation: { label: "Contexte", label_inid: "Contexte du décor", label_inicm: "" } },
    COTE: { type: String, default: "", documentation: { label: "" } },
    DATE: { type: String, default: "", documentation: { label: "Datation", label_inid: "Datation", label_inicm: "Datation"} },
    DATDEB: { type: String, default: "", documentation: { label: "" } },
    DATFIN: { type: String, default: "", documentation: { label: "" } },
    DIMS: { type: String, default: "", documentation: { label: "Dimensions du codex", label_inid: "Dimensions du codex", label_inicm: "Dimensions du codex" } },
    ETAB: { type: String, default: "", documentation: { label: "Établissement de conservation", label_inid: "Etablissement de conservation", label_inicm: "Etablissement de conservation" } },
    FOPG: { type: String, default: "", documentation: { label: "" } },
    FOLIOS: { type: String, default: "", documentation: { label: "Folios", label_inid: "Numéro de feuillet", label_inicm: "Foliotation du manuscrit" } },
    LANGOUV: { type: String, default: "", documentation: { label: "", label_inid: "", label_inicm: "Langue(s)" } },
    NFICH: { type: String, default: "", documentation: { label: "" } },
    NVUE: { type: String, default: "", documentation: { label: "" } },
    NOMENC: { type: [String], default: [], documentation: { label: "Domaine", label_inid: "", label_inicm: "Thème(s)" } },
    NOTES: { type: String, default: "", documentation: { label: "Notes manuscrit", label_inid: "Notes", label_inicm: "Notes" } },
    NOTDEC: { type: String, default: "", documentation: { label: "Remarques sur le décors", label_inid: "Notes sur l’enluminure", label_inicm: "" } },
    OPHOT: { type: String, default: "", documentation: { label: "" } },
    ORIGG: { type: String, default: "", documentation: { label: "Origine géographique", label_inid: "", label_inicm: "Origine géographique" } },
    ...
    TYPE: { type: String, default: "", documentation: { label: "", label_inid: "Type codicologique", label_inicm: "" } },
    POSS: { type: [String], default: [], documentation: { label: "Possesseur", label_inid: "", label_inicm: "Ancien(s) possesseur(s)" } },
    REFD: { type: String, default: "", documentation: { label: "Cote", label_inid: "Cote", label_inicm: "Cote" } },
    ...
    SUJET: { type: String, default: "", documentation: { label: "Titre de l'enluminure / Sujet", label_inid: "Titre ou sujet de l'enluminure", label_inicm: "" } },
    SUPP: { type: String, default: "", documentation: { label: "" } },
    TITR: { type: String, default: "", documentation: { label: "Titre de l'ouvrage", label_inid: "Titre de l'oeuvre", label_inicm: "Titre de l'oeuvre" } },
    TYPDEC: { type: String, default: "", documentation: { label: "Typologie du décors", label_inid: "", label_inicm: "Typologie(s) des décors" } },
    TYPCOD: { type: String, default: "", documentation: { label: "Type codicologique", label_inid: "", label_inicm: "Type codicologique" } },

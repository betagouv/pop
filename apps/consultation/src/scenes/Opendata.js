...
export default () => (
  <div className="opendata-view">
    ...
    <div>
      ...
       <br />
      <br />
      Les informations consultables sur la plateforme POP, ce comprenant les informations textuelles
      et multimédia, sont pour partie soumises, expressément ou supposément, au droit d’auteur et ne
      peuvent à ce titre être diffusées ou réutilisées par des tiers sans l’autorisation préalable
      de l’auteur ou des ayants droit.
      <br />
       <br />
      Dans un souci de clarté et de simplicité pour les ré-utilisateurs, les informations publiques
      au sens du code des relations entre le public et l’Administration, regroupées au sein de la
      plateforme POP, sont téléchargeables au lien suivant.
      <br />
       <br />
      ...
      d’auteur, notamment disponibles sur l’interface de consultation mais pas en téléchargement au
      lien mentionné ci-dessus, le ré-utilisateur doit obtenir les autorisations nécessaires auprès
      des auteurs et ayant-droits.
      <br />
       <br />
      Similairement certaines des informations diffusées sur la plateforme POP peuvent comporter des
      données à caractère personnel pour lesquelles les ré-utilisateurs sont tenus au respect de la
      loi Informatique et Libertés (lien).
      <br />
       <br />
      ...
      d'anonymisation des éléments permettant de les identifier ; ainsi qu'au respect de l'intégrité
      des informations, en veillant à ce que la teneur et la portée des informations ne soient pas
      altérées par des retraitements (modification des informations, insertion de commentaires sans
      que ceux-ci puissent être clairement distingués du contenu de l'administration, coupes
      altérant le sens du texte ou des informations).
      <br />
      Il doit accompagner chaque rediffusion des informations de l'indication précise de l'origine
      et du lieu de conservation du document, date, référence, l'auteur et du titre du document s'il
      y a lieu.  <br />
      ...
      caractère personnel, aux articles 45 et suivants de la loi n° 78-17 du 6 janvier 1978 relative
      à l'informatique, aux fichiers et aux libertés.
      <br />
       <br />
      Pour toute question relative à la réutilisation du contenu des bases de données patrimoniales
      du Ministère de la Culture, vous pouvez nous écrire en utilisant le formulaire accessible à la
      page https://data.culture.gouv.fr/pages/contact/
      <br />
       <br />
      Pour toute demande d’information, réclamation ou demande de retrait du site de diffusion, vous
      pouvez adresser votre demande au service responsable à l’aide de l’onglet « Contactez-nous »
      présent sur chaque notice. <br />
      <br />
    </div>

		...
		return (
			<Container className="import">
				<Importer
					...
					report={report}
					readme={readme}
					fieldsToExport={[{ name: "Identifiant", key: "REF" }]}
					dropzoneText={
						<span>
							Glissez & déposez vos fichiers au format{" "}
							<b>enluminures</b> (<code>.csv</code>) et les images
							associées (au format <code>.jpg</code>) dans cette
							zone
						</span>
					}
	...
	return (
		<div>
			...
			<div>
				...
				<ul>
					<li>
						texte : csv (séparateur : point-virgule, encodage :
						UTF8){" "}
					</li>
				</ul>

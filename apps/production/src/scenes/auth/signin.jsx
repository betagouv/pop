			...
			<form>
				<Container className="signin">
					...
					<div>
						...
						<a href="mailto:pop@culture.gouv.fr">email</a> avec les
						informations suivantes : <br />
						<br />- Institution <br />- Domaine (MNR, Inventaire,
						Monuments Historiques, Joconde ou Base archives photo)
						<br />- Nom <br />- Prénom <br />
						<br />
					</div>
					<div className="error">
					...
					<div className="block">
						...
						<Row>
							...
							<Col>
								<Link
									className="forget-password float-right"
									to="/auth/forget"
								>
									Mot de passe oublié&nbsp;?
								</Link>

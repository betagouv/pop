...
class UpdateProfile extends Component {
	...
	resetPasswordMessage() {
		...
		return (
			<p>
				Vous n&apos;avez pas encore chang&eacute; votre mot de passe.
				Pour votre s&eacute;curit&eacute;, vous devez le changer avant
				de continuer.
			</p>
		);
	}
		...
		return (
			<p className="lastConnectedAt">
				<em>
					...
					{new Date(this.props.lastConnectedAt).toLocaleString(
						"fr-FR",
					)}
				</em>
			</p>
...
export default connect(mapStateToProps, { logout, signinByToken })(
	UpdateProfile,
);

...
class UpdatePassword extends Component {
	...
	updatePassword() {
		...
		api.updatePassword({ email: this.props.email, pwd, pwd1, pwd2 })
			.then(() => {
	...
	resetPasswordMessage() {
		...
		return (
			<p>
				Vous n'avez pas encore changé votre mot de passe. Pour votre
				sécurité, vous devez le changer avant de continuer.
			</p>
		);
	}

			...
			<div className="base-prefixes-fields">
				...
				<div className="inline-container">
					<Input
						...
						onChange={(e) =>
							this.setBase(this.props.index, e.target.value)
						}
					>
						{bases}
					</Input>
					<Button
						className="deleteBaseButton"
						onClick={() =>
							this.props.deleteBaseLine(this.props.index)
						}
					>
						-
					</Button>
				...
				<PrefixInput
					...
					handleUpdateBase={this.props.handleUpdateBase}
				/>
			</div>
		);
	}

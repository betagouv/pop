        ...
        <Row>
          <Col sm="9">
            ...
            <div className="notice-details">
              ...
              <Field title="Ancien titre :" content={this.state.notice.ATIT} />
              <Field
                title="Précision titre :"
                content={this.state.notice.PTIT}
              />
              <Field title="Autre titre :" content={this.state.notice.AUTI} />
              <Field title="Dénomination :" content={this.state.notice.DENO} />
              <Field title="Millénaire :" content={this.state.notice.MILL} />
              ...
              <Field title="Observations :" content={this.state.notice.OBSE} />
              <Field

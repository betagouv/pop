        ...
        <Row>
          <Col sm="9">
            ...
            <div className="notice-details">
              ...
              <Field title="Destinataire : " content={this.state.notice.GENR} />
              <Field
              ...
              />
              <Field title="Aire d'étude : " content={this.state.notice.AIRE} />
              ...
              />
              <Field title="Cours d'eau : " content={this.state.notice.HYDR} />
              <Field
              ...
              />
              <Field title="Parti de plan :" content={this.state.notice.PLAN} />
              <Field
              ...
              <Field title="Typologie : " content={this.state.notice.TYPO} />
              <Field
              ...
              />
              <Field title="Date du label :" content={this.state.notice.DLAB} />
              ...
              />
              <Field title="Affectataire :" content={this.state.notice.AFFE} />
              <Field
  ...
  if (notice.DOSURLPDF) {
    arr.push(
      <li key='notice.DOSURLPDF'>
        <a href={notice.DOSURLPDF} target="_blank">Dossier pdf</a>
      </li>
    );
  }

...
export default class Palissy extends Notice {
    constructor(body) {
        ...
        this.IMPL = { type: 'String', value: body.IMPL || '', thesaurus: 'http://data.culture.fr/thesaurus/resource/ark:/67717/T12' };
        ...
        this.INTE = { type: 'String', value: body.INTE || '', thesaurus: 'http://data.culture.fr/thesaurus/resource/ark:/67717/T33' };
        ...
        this.PERS = { type: 'Array', value: this.extractArray(body.PERS), thesaurus: 'http://data.culture.fr/thesaurus/resource/ark:/67717/T6' };
        ...
        this.PROT = { type: 'String', value: body.PROT || '', thesaurus: 'http://data.culture.fr/thesaurus/resource/ark:/67717/T10' };
        ...
        this.SCLE = { type: 'Array', value: this.extractArray(body.SCLE), thesaurus: 'http://data.culture.fr/thesaurus/resource/ark:/67717/T17' };

...
export default class Merimee extends Notice {
    constructor(body) {
        ...
        this.AFFE = { type: 'String', value: body.ADRS || '', thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T97" };
        this.AIRE = { type: 'String', value: body.AIRE || '' };
        this.APPL = { type: 'String', value: body.APPL || '' };
        this.APRO = { type: 'Array', value: this.extractArray(body.APRO), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T98" };
        ...
        this.COPY = { type: 'Array', value: this.extractArray(body.COPY), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T21" };
        this.COUV = { type: 'Array', value: this.extractArray(body.COUV), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T26" };
        ...
        this.DEPL = { type: 'String', value: body.DEPL || '', thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T14" };
        this.DESC = { type: 'String', value: body.DESC || '' };
        this.DIMS = { type: 'String', value: body.DIMS || '', thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T11" };
        this.DMAJ = { type: 'String', value: body.DMAJ || '', generated: true };
        this.DMIS = { type: 'String', value: body.DMIS || '', generated: true };
        this.DOSS = { type: 'String', value: body.DOSS || '', thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T13" };
        this.DPRO = { type: 'String', value: body.DPRO || '' };
        this.DPT = { type: 'String', value: body.DPT || '' };
        this.EDIF = { type: 'String', value: body.EDIF || '' };
        this.ELEV = { type: 'Array', value: this.extractArray(body.ELEV), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T25" };
        this.ENER = { type: 'Array', value: this.extractArray(body.ENER), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T27" };
        this.ESCA = { type: 'Array', value: this.extractArray(body.ESCA), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T29" };
        this.ETAG = { type: 'Array', value: this.extractArray(body.ETAG), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T23" };
        this.ETAT = { type: 'Array', value: this.extractArray(body.ETAT), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T30" };
        this.ETUD = { type: 'Array', value: this.extractArray(body.ETUD), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T68" };
        this.GENR = { type: 'Array', value: this.extractArray(body.GENR), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T197" };
        this.HIST = { type: 'String', value: body.HIST || '' };
        this.HYDR = { type: 'String', value: body.HYDR || '' };
        this.IMPL = { type: 'Array', value: this.extractArray(body.IMPL), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T12" };
        this.INSEE = { type: 'String', value: body.INSEE || '' };
        this.INTE = { type: 'Array', value: this.extractArray(body.INTE), thesaurus: "http://data.culture.fr/thesaurus/resource/ark:/67717/T33" };
